...
namespace FlowchartConverter.Utilities
{
    class Pair
    {
        XmlNode xmlNode;
    ...
    class Loader
    {
        private TerminalNode startNode;
        private TerminalNode endNode;
        private List<Pair> blockNodes = new List<Pair>();
        ...
        private void onValidateEnd(object sender, ValidationEventArgs e)
        {
